...
import 'package:codia_demo_flutter/codia_page03.dart';

class CodiaPage02 extends StatefulWidget {
  const CodiaPage02({super.key});

  @override
  State<CodiaPage02> createState() => _CodiaPageState02();
}

class _CodiaPageState02 extends State<CodiaPage02> {
  @override
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text(
                      'จงทำการลากเส้นจากจุดเริ่มต้นถึงจุดสิ้นสุด แบบเรียงลำดับ',
    ...
    onPressed: () {
      if (text == 'ออก') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const CodiaPage03(), // หน้าถัดไป (CodiaPage03)
          ),
        );
      }
    },
