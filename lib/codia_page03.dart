...
class CodiaPage03 extends StatefulWidget {
  const CodiaPage03({super.key});

  @override
  State<CodiaPage03> createState() => _CodiaPageState03();
}

class _CodiaPageState03 extends State<CodiaPage03> {
  @override
    ...
    onPressed: () {
      if (text == 'ออก') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const CodiaPage04(), // หน้าถัดไป (CodiaPage03)
          ),
        );
      }
    },
