...
import 'package:codia_demo_flutter/codia_page05.dart';

class CodiaPage04 extends StatefulWidget {
  const CodiaPage04({super.key});

  @override
  State<CodiaPage04> createState() => _CodiaPageState04();
}

class _CodiaPageState04 extends State<CodiaPage04> {
   @override
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  ...
                  child: const Center(
                    child: Text(
                      'จงวาดหน้าปัดนาฬิกาบอกเวลาที่ 12:30 น.',
    ...
    onPressed: () {
      if (text == 'ออก') {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => const CodiaPage05(), // หน้าถัดไป (CodiaPage03)
          ),
        );
      }
    },
