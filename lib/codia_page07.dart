...
import 'package:codia_demo_flutter/correct_answer_provider.dart'; // นำเข้า CorrectAnswerProvider
...
class _CodiaPageState07 extends State<CodiaPage07> {
  ...
  Widget build(BuildContext context) {
    // ใช้ Consumer เพื่อดึง correctAnswer จาก CorrectAnswerProvider
    return Consumer<CorrectAnswerProvider>(
      builder: (context, correctAnswerProvider, child) {
        final correctAnswer = correctAnswerProvider.correctAnswer;

        return Scaffold(
          appBar: AppBar(
            title: Text(correctAnswer.toString()),  // ใช้ correctAnswer ที่ได้จาก Provider
          ),
          body: Center(
            child: Container(
              width: 1366,
